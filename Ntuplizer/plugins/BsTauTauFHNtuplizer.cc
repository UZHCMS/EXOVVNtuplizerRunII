...
//  std::cout << "DNN file =" << dnnfile_ << std::endl;
  std::cout << "Confirm (dzcut, fsigcut, vprobcut, dnn cut) = " << c_dz << " " << c_fsig << " " << c_vprob << " " << std::endl;
...
//	    std::cout << "\t\t pt response = " << (tau2_pi3.Pt()/tlvs[nnn].Pt()) << ", delta_R = " << reco::deltaR(tau2_pi3.Eta(), tau2_pi3.Phi(), tlvs[nnn].Eta(), tlvs[nnn].Phi())  << std::endl;
	...
	nBranches_->BsTauTauFH_tau1_rhomass2.push_back(rhomass1.at(-1));
      ...
      nBranches_->BsTauTauFH_tau1_sumofdnn.push_back(1); //mydnn[tau1_idx1] + mydnn[tau1_idx2] + mydnn[tau1_idx3]);
      ...
      nBranches_->BsTauTauFH_tau1_pi1_dnn.push_back(1); //mydnn[tau1_idx1]);
      nBranches_->BsTauTauFH_tau1_pi2_dnn.push_back(1); //mydnn[tau1_idx2]);
      nBranches_->BsTauTauFH_tau1_pi3_dnn.push_back(1); //mydnn[tau1_idx3]);
	...
	nBranches_->BsTauTauFH_tau2_rhomass2.push_back(rhomass2.at(-1));
      ...
      nBranches_->BsTauTauFH_tau2_sumofdnn.push_back(1); //mydnn[tau2_idx1] + mydnn[tau2_idx2] + mydnn[tau2_idx3]);
      ...
      nBranches_->BsTauTauFH_tau2_pi1_dnn.push_back(1); //mydnn[tau2_idx1]);
      nBranches_->BsTauTauFH_tau2_pi2_dnn.push_back(1); //mydnn[tau2_idx2]);
      nBranches_->BsTauTauFH_tau2_pi3_dnn.push_back(1); //mydnn[tau2_idx3]);
