...
#ifndef JpsiKNtuplizer_H
#define JpsiKNtuplizer_H

#include <TRandom3.h>


class JpsiKNtuplizer : public CandidateNtuplizer {


 public:
  JpsiKNtuplizer( edm::EDGetTokenT<pat::MuonCollection>    muonToken   , 
